...
const trustees = [
    {image: trusteeImg, name: 'Melissa Ryan', message: `“John is a trustworthy person and He has never for once owned a single penny”`},
    {image: trusteeImg, name: 'Aliyah Parker', message: `“John is a trustworthy person and He has never for once owned a single penny”`},
    {image: trusteeImg, name: 'Alicia Knowles', message: `“John is a trustworthy person and He has never for once owned a single penny”`},
    {image: trusteeImg, name: 'Melissa Ryan', message: `“John is a trustworthy person and He has never for once owned a single penny”`},
    {image: trusteeImg, name: 'Melissa Ryan', message: `“John is a trustworthy person and He has never for once owned a single penny”`},
    {image: trusteeImg, name: 'Melissa Ryan', message: `“John is a trustworthy person and He has never for once owned a single penny”`}
]
    ...
    return (
        <div className={['container', styles.UserProfile].join(' ')}>
            ...
            <div className="row">
                <div className="col-md-3 text-md-center text-sm-left ">
                    <div className="d-flex flex-md-column flex-sm-row align-items-center">
                        <img className={styles.ProfileImg} src={profileImg} alt="user profile" />
                        <div className="ml-3 ml-md-0">
                            <h4 className={[styles.Username, "text-center", "font-weight-bold", "mt-2", "mb-0", "mb-md-3"].join(' ')}>John Ramsay</h4>
                            <p className={styles.UserType}>Fundee</p>
                        </div>
                    </div>
                    <Link to='/user-profile' className={styles.Edit}>
                        <svg width="1.8em" height="1.8em" viewBox="0 0 16 16" className="bi bi-pencil-square pr-2" fill="#FB3F5C" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-md-8 offset-md-1">
                    <h2 className="font-weight-bold mt-md-0 mt-5">Basic Information</h2>
                    <div className="row">
                        <div className="col-md-5">
                            <ProfileInfo title="Full Name">John Ramsey Odion</ProfileInfo>
                            <ProfileInfo title="Contact Information">4456-6785-6789-7895</ProfileInfo>
                        ...
                        <div className="col-md-7">
                            ...
                            <ProfileInfo title="Email address">johnodion@gmail.com</ProfileInfo>
                            <ProfileInfo title="Occupation">Software Intern at Andela</ProfileInfo>
                        </div>
                    </div>
                </div>
            ...
            <div className={styles.Recommendations}>
                <div className={["d-flex", "align-items-center", "justify-content-between", styles.RecommendHeader].join(' ')}>
