        ...
        return (
            <div className="container-fluid py-0 bg-light payment-card">
                <div className="row vh-100 justify-content-center align-items-center px-4 px-md-0">
                    <div className={["col-sm-8 col-md-6 col-lg-4 shadow-sm px-0 px-lg-0 px-xl-5 py-5 bg-white", PaymentCss.box_shadow, PaymentCss.payment_card].join(' ')}>
                        <h2 className="text-center">Enter your OTP</h2>
                        <form className="px-5 mt-4" onSubmit={this.onHandleSubmit}>
                            <div className="form-group">
                                <input 
                                    type="number" 
                                    className={[PaymentCss.form_control, PaymentCss.number_field, "d-block w-100 py-2 py-md-3 px-3 text-center font-weight-bold"].join(' ')} 
                                    id="otp"
                                    value={otp}
