                        ...
                        <form onSubmit={onSubmit} method="POST">
                            ...
                            <div class="form-row">
                                <div className="form-group col-md-6 col-6 mb-4">
                                    <label for="" className="editProfileLabel mb-0 h6 font-weight-light" >First Name</label>
                                    <input 
                                    type="name" 
                                ...
                                <div className="form-group col-md-6 col-6 mb-4">
                                    <label for="" className="editProfileLabel mb-0 h6 font-weight-light" >Last Name</label>
                                    <input 
                                    type="name" 
                                    class="form-control form-control-sm" 
                            ...
                            <div class="form-row">
                                <div className="form-group col-md-6 col-6 mb-4">
                                    <label for="" className="editProfileLabel  mb-0 h6 font-weight-light" >Contact Information</label>
                                    <input 
                                    type="phone" 
                                    class="form-control form-control-sm" 
                                    id="" 
                                ...
                                <div className="form-group col-md-6 col-6 mb-4">
                                    <label for="" className="editProfileLabel mb-0 h6 font-weight-light" >Email Address</label>
                                    <input 
                                    type="email" 
                                    class="form-control form-control-sm" 
                                    value={email}
                            ...
                            <div class="form-row">
                                <div className="form-group col-md-6 col-6 mb-0">
                                    <label for="" className="editProfileLabel mb-0 h6 font-weight-light" >Gender</label>
                                    <input 
                                    type="text"
                                    id="inputState" 
                                    value={"Male"}
                                ...
                                <div className="form-group col-md-6 col-6">
                                    <label for="" className="editProfileLabel mb-0 h6 font-weight-light" >Occupation</label>
                                    <input 
                                    type="text" 
                                    class="form-control form-control-sm" 
                                    value={occupation}
                            ...
                            <div class="form-row mt-0">
                                <div className="form-group col-md-12 col-12">
                                    <label for="" className="editProfileLabel mb-0 h6 font-weight-light" >Address</label>
                                    <input 
                                    type="address" 
                                    class="form-control form-control-sm" 
                                    value={addressP}
            ...
            <div className="row mt-5 mb-5">
                ...
                <form>
                    <div className="form-row ">
                        <div className="form-group col-md-6 col-6">
                            <label for="" className="mb-0 h6 font-weight-light editProfileLabel " >New Password</label>
                            <input type="password" className="form-control form-control-sm " id="" placeholder="................" />
                        </div>
                        <div className="col-md-6"></div>
                        <div className="form-group col-md-6 col-6">
                            <label for="" className="mb-0 h6 font-weight-light editProfileLabel " >Confirm Password</label>
                            <input type="password" className="form-control form-control-sm opacity-2 " id="" placeholder="..............." />
                        </div>
                    </div>
                    <button type="submit" className="btn btn-primary col-md-6 col-6 btn-fml-secondary">Save New Password</button>
                    </form>
                </div>
